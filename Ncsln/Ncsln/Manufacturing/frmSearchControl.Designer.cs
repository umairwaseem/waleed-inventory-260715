namespace Ncsln.Manufacturing
{
    partial class frmSearchControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.dsItemSearch = new Ncsln.Manufacturing.dsItemSearch();
            ...
            this.daItemSearchFromManufacturing = new System.Data.SqlClient.SqlDataAdapter();
    ...
    "ue;Integrated Security=True";
            ...
            // sqlSelectCommand1
            // 
            this.sqlSelectCommand1.CommandText = "SELECT Id, Name, Code, PurchasePrice, OverHead\r\nFROM     ItemList\r\nWHERE  (Name L" +
    "IKE \'%\' + @key + \'%\') AND (Hide = 0) OR\r\n                  (Hide = 0) AND (Code " +
    "LIKE \'%\' + @key + \'%\')";
            ...
            // 
            // daItemSearchFromManufacturing
            // 
            this.daItemSearchFromManufacturing.DeleteCommand = this.sqlCommand1;
            this.daItemSearchFromManufacturing.InsertCommand = this.sqlCommand2;
            this.daItemSearchFromManufacturing.SelectCommand = this.sqlCommand3;
            this.daItemSearchFromManufacturing.TableMappings.AddRange(new System.Data.Common.DataTableMapping[] {
            new System.Data.Common.DataTableMapping("Table", "ItemList", new System.Data.Common.DataColumnMapping[] {
                        new System.Data.Common.DataColumnMapping("Id", "Id"),
                        new System.Data.Common.DataColumnMapping("Name", "Name"),
                        new System.Data.Common.DataColumnMapping("Code", "Code"),
                        new System.Data.Common.DataColumnMapping("PurchasePrice", "PurchasePrice"),
                        new System.Data.Common.DataColumnMapping("OverHead", "OverHead")})});
            this.daItemSearchFromManufacturing.UpdateCommand = this.sqlCommand4;
            // 
            // sqlCommand1
            // 
        ...
        private System.Data.SqlClient.SqlDataAdapter daItemSearchFromManufacturing;
