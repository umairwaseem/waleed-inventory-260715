...
namespace Ncsln.Inventory
{
    public partial class frmStockRectify : Form
    {
        ...
        {
            this.ObjCore.fillComboBoxOptioni(this.cmbItems, "Select ItemId, Code + ' ' + Title + ' (' + Convert(nvarchar(50), ItemId) + ')' from Items where ItemId > 10000", this.ObjCore.getClientConnectionString());
            this.LoadDGV();
        }
        ...
        private void LoadDGV()
        {
            try
            {
                ...
                this.daStockRectify.SelectCommand.Connection.ConnectionString = this.ObjCore.getClientConnectionString();
            ...
            try
            {
                if (e.RowIndex != -1)
                {
                    ...
                    if (e.ColumnIndex == this.dgv.Columns["Edit"].Index)
                    {
                        ...
                        DataTable dt = this.ObjCore.getDataSet("Select * from SStockRectify where Id = '" + currentId + "'", this.ObjCore.getClientConnectionString()).Tables[0];
