...
{
    partial class frmVendorGPayments
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmVendorGPayments));
            ...
            this.vendorGPaymentBindingSource = new System.Windows.Forms.BindingSource(this.components);
            this.dsVendorGPayment1 = new Ncsln.Master.dsVendorGPayment();
            ...
            ((System.ComponentModel.ISupportInitialize)(this.vendorGPaymentBindingSource)).BeginInit();
            ((System.ComponentModel.ISupportInitialize)(this.dsVendorGPayment1)).BeginInit();
            this.SuspendLayout();
            // 
            // panel1
            // 
            ...
            this.txtDetail.Location = new System.Drawing.Point(260, 268);
            ...
            this.txtPayment.Location = new System.Drawing.Point(554, 153);
            ...
            this.txtPayment.ValueChanged += new System.EventHandler(this.txtPayment_ValueChanged);
            // 
            // label4
            // 
            this.label4.Anchor = System.Windows.Forms.AnchorStyles.Top;
            this.label4.AutoSize = true;
            this.label4.Location = new System.Drawing.Point(557, 128);
            ...
            this.dtp.Location = new System.Drawing.Point(258, 153);
            ...
            this.cmbVendors.Location = new System.Drawing.Point(258, 95);
            ...
            this.Edit,
            this.Delete});
            this.dgv.DataSource = this.vendorGPaymentBindingSource;
            ...
            new System.Data.Common.DataTableMapping("Table", "VendorGPayment", new System.Data.Common.DataColumnMapping[] {
    ...
    "y Info=True;User ID=cruxtech;Password=crux123";
            ...
            // sqlCommand1
            // 
            this.sqlCommand1.CommandText = "SELECT Id, Vendorg_Id AS Vendor_Id, PaymentDate, Amount, Description, AccountNo, " +
    "BankName\r\nFROM     VendorGPayment\r\nORDER BY Id DESC";
            ...
            // sqlCommand4
            // 
            this.sqlCommand4.CommandText = "SELECT Id, Vendorg_Id AS Vendor_Id, PaymentDate, Amount, Description, AccountNo, " +
    "BankName\r\nFROM     VendorGPayment\r\nWHERE  (Vendorg_Id = @id)\r\nORDER BY Id DESC";
            ...
            this.txtBankName.Location = new System.Drawing.Point(258, 209);
            ...
            this.label7.Location = new System.Drawing.Point(258, 186);
            ...
            this.txtAccountNo.Location = new System.Drawing.Point(554, 209);
            ...
            // 
            // vendorGPaymentBindingSource
            // 
            this.vendorGPaymentBindingSource.DataMember = "VendorGPayment";
            this.vendorGPaymentBindingSource.DataSource = this.dsVendorGPayment1;
            // 
            // dsVendorGPayment1
            // 
            this.dsVendorGPayment1.DataSetName = "dsVendorGPayment";
            this.dsVendorGPayment1.SchemaSerializationMode = System.Data.SchemaSerializationMode.IncludeSchema;
            // 
            // id
            // 
            ...
            this.Name = "frmVendorGPayments";
            this.Text = "General Vendor Payments";
            ...
            ((System.ComponentModel.ISupportInitialize)(this.vendorGPaymentBindingSource)).EndInit();
            ((System.ComponentModel.ISupportInitialize)(this.dsVendorGPayment1)).EndInit();
        ...
        private Ncsln.Master.dsVendorGPayment dsVendorGPayment1;
        private System.Windows.Forms.BindingSource vendorGPaymentBindingSource;
